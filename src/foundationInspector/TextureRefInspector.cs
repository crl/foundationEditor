...
{
    [CustomEditor(typeof(TextureRef))]
    [CanEditMultipleObjects]
    public class TextureRefInspector : BaseInspector<TextureRef>
    {
        ...
        protected override void OnEnable()
        {
            ...
            SerializedProperty p = serializedObject.FindProperty("textureSet");
            reorderableList = new ReorderableList(serializedObject, p, true, true, true, true);

            reorderableList.drawHeaderCallback = (Rect rect) => { GUI.Label(rect, "TextureSet"); };
