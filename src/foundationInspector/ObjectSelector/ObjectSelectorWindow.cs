...
public class ObjectSelectorWindow : EditorWindow
{
    ...
    public static void ShowObjectPicker(Type type,UnityEngine.Object obj,SerializedProperty property, Action<UnityEngine.Object> itemSelectedCallback, string folderPath = "Assets", List<int> allowedInstanceIDs = null)
    {
        get.Show(obj, type, property, itemSelectedCallback, folderPath, allowedInstanceIDs);
    }
