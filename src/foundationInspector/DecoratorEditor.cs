namespace foundationEditor
{
    ...
    public abstract class DecoratorEditor : Editor
    {
        ...
        protected static Assembly editorAssembly = Assembly.GetAssembly(typeof(Editor));

        protected static Assembly editorWindowAssembly = Assembly.GetAssembly(typeof(EditorWindow));
